...
This form of the Riemann Zeta Function is **'meromorphic'**, meaning convergent everywhere except at one <strong>'simple pole (singularity)'</strong>, namely $re(s)=1$, for which $\frac{1}{\zeta(s)}$ approaches $0$.

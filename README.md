...
<p/>
Now, in the complex number case, we would have $s=a+bi$ where $re(s)=a$ and $im(s)=b$, then sum $\zeta(s)$ wil have a <strong>'simple pole (singularity)'</strong> at $re(s)=1$ and not convergent for $0$.
## Background

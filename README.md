...
<p/>
However, through some very complicated calculations, more zeros are found with 
$$s=\frac{1}{2}+14.134...i$$,
$$s=\frac{1}{2}+21.022...i$$,
$$s=\frac{1}{2}+25.010...i$$ and so on, they behave almost without any pattern, and are called the <strong>non-trivial zeros</strong>.
<p/>(...to be continued...)

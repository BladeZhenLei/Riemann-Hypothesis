...
<p/>
Now, in the complex number case, we would have $s=a+bi$ where $re(s)=a$ and $im(s)=b$, then as usual the sum $\zeta(s)$ wil have a simple pole (singularity) at $re(s)=1$, and the region $0<re(s)$ is <strong>not convergent</strong>. 
<p/>

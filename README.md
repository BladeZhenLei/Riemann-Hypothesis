...
The particular method Riemann used in his 1859 paper was a coutour integral, by going around the origin from $+\infty$ back to $+\infty$ 
<p align="center"><img src= "https://user-images.githubusercontent.com/66701331/183789823-ef68d926-2be2-45d8-a984-72cccf377d33.png" width="300" height="100"> <p/>

and yielded 
$$\zeta(s)=\frac{\Gamma(s)}{2{\pi}{i}}\int_{a}^{b} x^2\,dx$$

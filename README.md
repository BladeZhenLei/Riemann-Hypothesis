...
<p/>
If we take a look at number $n$, we use the function $\pi(n)$ to describe how many primes smaller than $n$ are there, this function is called the prime counting function.
<br/>
